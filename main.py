...
class ActivityIndicatorForm(Form):
    ...
    def __config_comps(self):
        self.caption = "Тест стилей и индикатора задержки"
        self.SetProps(ClientHeight = 380, ClientWidth = 570, Position = "poScreenCenter", OnClose = self.__on_form_close)
        ...
        #Configure the menu items
        self.mi_file.SetProps(Caption = "Файл")
        self.mi_load_style.SetProps(Caption = "Открыть папку стилей...", OnClick = self.__on_load_style_click)
        self.mi_exit.SetProps(Caption = "Выход", OnClick = (lambda sender: Application.Terminate()))
        #Configure the FileOpenDialog
        self.od_styles.SetProps(Title = "Выберите каталог со стилями", options = ["fdoPickFolders", "fdoPathMustExist", "fdoForceFileSystem"], OkButtonLabel = "Выбрать")
        #Configure further components
        self.lbl_frame_delay.SetProps(Parent = self, Left = 245, Top = 55, Width = 88, Height = 15, Caption = 'Задержка вращения (50)')
        self.lbl_vcl_style.SetProps(Parent = self, Left = 20, Top = 124, Width = 49, Height = 15, Alignment = "taRightJustify", Caption = 'Стиль')
        self.lbl_form_color.SetProps(Parent = self, Left = 245, Top = 126, Width = 220, Height = 15, Caption = 'Цвет окна (только Windows стиль)')
        self.chk_animate.SetProps(Parent = self, Left = 254, Top = 20, Width = 96, Height = 17, Caption = 'Анимация задержки', TabOrder = 0, OnClick = self.__chk_animate_click)
        ...
        self.cbx_form_color.SetProps(Parent = self, Left = 245, Top = 147, Width = 238, Height = 22, TabOrder = 3, OnChange = self.__cbx_form_color_change)

        self.grp_indicator_type.SetProps(Parent = self, Left = 20, Top = 193, Width = 195, Height = 117, Caption = 'Тип индикатора', TabOrder = 4, OnClick = self.__grp_indicator_type_click)
        ...
        self.grp_indicator_size.SetProps(Parent = self,  Left = 235, Top = 193, Width = 160, Height = 117, Caption = 'Размер индикатора', TabOrder = 5, OnClick = self.__grp_indicator_size_click)
        ...
        self.grp_indicator_color.SetProps(Parent = self, Left = 410, Top = 193, Width = 140, Height = 117, Caption = 'Цвет индикатора', TabOrder = 6, OnClick = self.__grp_indicator_color_click)
    ...
    def __trk_frame_delay_change(self, sender):
        ...
        self.lbl_frame_delay.Caption = f"Задержка фрейма ({self.ai.FrameDelay})"
...
def main():
    ...
    Application.Title = "Индикатор активности"
